...
const inventoryMovementsTableName =
  import.meta.env.EXPO_PUBLIC_SUPABASE_INVENTORY_MOVEMENTS_TABLE || 'inventory_movements'
...
export const webInventoryService = {
  ...
  async record(
    ...
    const result = await webSupabaseClient
      ...
      .insert({
        ...
        movement_type: movement.type === 'sale_output' ? 'sale' : movement.type,
